function Footer() {
    return (
        <footer className="bg-hero-bg-dark text-white">
                    ...
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                            <input
                                ...
                                className="flex-1 px-4 py-3 rounded-lg bg-neutral-800 border border-neutral-700 text-white placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-hero-accent focus:border-transparent"
                            />
                            <button
                                type="submit"
                                className="bg-hero-accent text-hero-bg-dark px-6 py-3 rounded-lg font-semibold hover:bg-hero-accent-dark transition-colors whitespace-nowrap"
                            >
                                Subscribe
                            </button>
                        </form>
